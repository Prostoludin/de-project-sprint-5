...
from sprint5.dds_project.insert_data_dag.loader import User_Loader, Restaurant_Loader, Order_Ts_Loader, Order_Loader
from sprint5.dds_project.insert_data_dag.loader import DeliveryTsLoader, Courier_Loader, DeliveryLoader, FctDeliveryLoader
...
@dag(
    ...
    tags=['sprint5', 'dds_project', 'origin'],  # Теги, используются для фильтрации в интерфейсе Airflow.
    is_paused_upon_creation=True  # Остановлен/запущен при появлении. Сразу запущен.
)

def project_from_stg_to_dds_common_dag():
    ...
    def load_timestamps():
        rest_loader = Order_Ts_Loader(dwh_pg_connect, log)
...
order_dds_dag = project_from_stg_to_dds_common_dag()