CREATE TABLE IF NOT EXISTS cdm.dm_settlement_report (
	...
	CONSTRAINT dm_settlement_orders_total_sum_count_check CHECK ((orders_total_sum >= (0)::numeric)),
	...
	CONSTRAINT dm_settlement_restaurant_id_check UNIQUE (restaurant_id, settlement_date),
