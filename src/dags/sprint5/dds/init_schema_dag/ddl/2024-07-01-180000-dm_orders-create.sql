CREATE TABLE  IF NOT EXISTS dds.dm_orders (
	...
	CONSTRAINT dm_orders_delivery__ts_id_fkey FOREIGN KEY (delivery_ts_id) REFERENCES dds.dm_delivery_ts(id),
	CONSTRAINT dm_orders_delivery_id_fkey FOREIGN KEY (delivery_id) REFERENCES dds.dm_deliveries(id),
	CONSTRAINT dm_orders_restaurant_id_fkey FOREIGN KEY (restaurant_id) REFERENCES dds.dm_restaurants(id),
	CONSTRAINT dm_orders_timestamp_id_fkey FOREIGN KEY (order_ts_id) REFERENCES dds.dm_timestamps(id),
